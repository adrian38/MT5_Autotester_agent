...
class MultiterminalViewMixin:
    ...
    def _build_multiterminal(self, parent: ttk.Frame) -> None:
        ...
        editor = tk.Frame(panel, bg=self.colors["panel"], highlightthickness=1, highlightbackground=self.colors["border"])
        editor.grid(row=2, column=1, rowspan=2, sticky="nsew", padx=(0, 20), pady=(0, 18))
        editor.columnconfigure(1, weight=1)
        tk.Label(editor, text="Editor de terminal", bg=self.colors["panel"], fg=self.colors["text"],
