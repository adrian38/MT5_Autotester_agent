...
class SettingsLogicMixin:
    ...
    def _write_ui_settings(self) -> None:
        ...
        parser["General"] = {
            ...
            "ubs_copilot_model": self.ubs_copilot_model.get().strip(),
            "ubs_copilot_include_manual": "1" if self.ubs_copilot_include_manual.get() else "0",
            "ubs_copilot_max_manual_keys": self.ubs_copilot_max_manual_keys.get().strip(),
